...
class ReviewBlock(BaseModel):
    ...
    strengths: List[str] = Field(..., description="The positive aspects of the article.")
    issues: List[str] = Field(..., description="Problems identified in the article.")
    suggestions: List[str] = Field(..., description="Improvements suggested for editing.")
    ready_for_editing: bool = Field(..., description="Whether the report is ready for final editing.")
