...
def sample_report():
    return {
        ...
        "final_markdown": (
            ...
            "This is the final report content with **bold** text and "
            "`inline code`.\n\n"
            "## Section 1\n"
            "- Bullet item 1\n"
            "- Bullet item 2\n\n"
...
def test_export_pdf(tmp_path, sample_report):
    """
    Verify that export_pdf generates a valid PDF file with ReportLab and
    returns its path.
    """
...
def test_export_docx(tmp_path, sample_report):
    """
    Verify that export_docx generates a valid DOCX file using python-docx and
    returns its path.
    """
...
def test_export_invalid_path(tmp_path, sample_report):
    """
    Verify that export functions raise a ValueError when target directory does
    not exist or target is a directory.
    """
